...
function openSettings(){
  ...
  el("#settingsCard").innerHTML=`
    ...
    <div class="set-sec inc-sec"><h3>Must include — title words</h3>
      ...
      <div class="addrow"><input id="inckwadd" placeholder="add a word (e.g. designer)"><button data-add="inckw">Add</button></div>
    </div>
    <div class="set-sec inc-sec"><h3>Must include — cities</h3>
      ...
      <div class="addrow"><input id="inccityadd" placeholder="add a city (e.g. austin)"><button data-add="inccity">Add</button></div>
    </div>
